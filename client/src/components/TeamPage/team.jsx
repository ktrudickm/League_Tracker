          ...
          <div className="card" style={{width: "18rem"}}>
            <img className="card-img-top" src={team[0].image} alt="Team"/> 
              ...
              <ul className="list-group list-group-flush">
                  <li className="list-group-item">Championship: {team[0].stats[0].championships}</li>
                  <li className="list-group-item">Made Playoffs: {team[0].stats[0].madePlayoffs}</li>
                  <li className="list-group-item">Rank: {team[0].stats[0].rank}</li>
                  <li className="list-group-item">Wins: {team[0].stats[0].wins}</li>
                  <li className="list-group-item">Losses: {team[0].stats[0].losses}</li>
